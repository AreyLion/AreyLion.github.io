...
function validate(){
    ...
    if (!password_regexp1.test(password.value)) {
    	document.getElementById("false_password").innerHTML = "Введите не менее 6 символов";
    }
    else {
    	password_points += 1;
    }
    ...
    if (!password_regexp2.test(password.value)) {
    	document.getElementById("false_password").innerHTML += "<br />Должны содержаться цифры";
    }
    else {
    	password_points += 1;
    }
    ...
    if (!password_regexp3.test(password.value)) {
    	document.getElementById("false_password").innerHTML += "<br />Должны содержаться символы разных регистров";
    }
    else {
    	password_points += 1;
    }
    ...
    if (!password_regexp4.test(password.value)) {
    	document.getElementById("false_password").innerHTML += "<br />Должны содержаться спецсимволы: !@#$%^&*";
    }
    else {
    	password_points += 1;
    }
